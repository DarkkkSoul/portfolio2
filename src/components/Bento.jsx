   ...
   return (
      <div className='css-bento w-ful h-full *:shadow-lg/35 *:bg-lime-300/30 text-istok-400'>
         ...
         <div className='css-blog flex flex-col justify-center pl-3'>
            ...
            {
               isOpen &&
               <div className='fixed top-90 bottom-[25rem] left-5 right-5 z-50 flex backdrop-blur-md bg-gradient-to-br from-lime-200 to-green-300 rounded-xl shadow-2xl/50 p-5'>
         ...
         {/* socials */}
         <div className='css-social flex px-1 items-center justify-evenly relative'>
            {/* darkk.soul_ */}
            ...
            <p className={`absolute -top-4 right-6 text-sm bg-white/80 p-1.5 leading-none rounded-md tracking-wide ${isCopied ? 'block' : 'hidden'} text-istok-400`}>copied!</p>
         </div>
