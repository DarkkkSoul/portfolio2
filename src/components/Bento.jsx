      ...
      <div className='css-bento h-full *:shadow-lg/35 *:bg-lime-300/30 text-istok-400'>
         ...
         <div className='css-social flex flex-col justify-center text-istok-400'>
            ...
            <div className='flex px-1 items-center justify-evenly relative'>
               ...
               <a href="https://drive.google.com/file/d/1jKg7SY_IY62QWwEwhHEHSAgoS3q9x3IL/view" target='_blank' className='w-7.5 hover:scale-105 hover:-translate-y-2 transition-all cursor-pointer active:scale-90'><img src="/Icons/resume.png" /></a>
